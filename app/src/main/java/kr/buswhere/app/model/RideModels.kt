...
object DemoPlaces {
    ...
    /** 대회 시연 지도에서 직접 선택하는 울산·부산 정류장입니다. */
    val demoPickupStops = listOf(
        Place("31208", "동부아파트입구", "울산광역시 남구 · 버스택시과", GeoPointDto(35.52742029, 129.3225519), "BUS_STOP"),
        Place("31205", "수암시장앞", "울산광역시 남구 · 버스택시과", GeoPointDto(35.52792702, 129.3207326), "BUS_STOP"),
        Place("40404", "공업탑", "울산광역시 남구 · 버스택시과", GeoPointDto(35.53301001, 129.3097744), "BUS_STOP"),
        Place("40411", "달동현대아파트앞", "울산광역시 남구 · 버스택시과", GeoPointDto(35.53630572, 129.3237411), "BUS_STOP"),
        Place("40410", "강남초등학교", "울산광역시 남구 · 버스택시과", GeoPointDto(35.5358198, 129.3205483), "BUS_STOP"),
        Place("57172", "롯데마트", "부산광역시 · 버스운영과", GeoPointDto(35.23916902, 129.0927024), "BUS_STOP"),
    )
